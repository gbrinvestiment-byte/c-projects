...
int main () {
    ...
    */
    ...
    int torre = 1, bispo = 1, rainha, movimentoCavalo = 1;
    ...
    for (rainha = 1; rainha <=8; rainha++) {
     ...
     while (movimentoCavalo--){
        for(int cavalo = 1; cavalo <= 2; cavalo++){
            if (cavalo == 1){
                printf("A peça Cavalo se movimentou %d casa para cima. \n", cavalo);
            } else {
                printf("A peça Cavalo já se movimentou %d casas para cima. \n", cavalo);
            }
        }
        printf("A peça Cavalo se movimentou 1 casa para esquerda.\n");
     }
